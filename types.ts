...
export interface StoryboardScene {
  id: string; description: string; visualPrompt: string; cameraAngle: string; image: ImageFile | null; videoUrl: string | null; isLoading: boolean; isVideoLoading: boolean; error: string | null;
}
