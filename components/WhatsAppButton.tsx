...
const WhatsAppButton: React.FC = () => {
    return (
        <a
            ...
            className="fixed bottom-8 left-4 sm:left-8 z-[200] group flex items-center flex-row-reverse gap-3"
        >
            <div className="bg-white text-black px-4 py-2 rounded-2xl text-[10px] font-black shadow-2xl opacity-0 group-hover:opacity-100 transition-all -translate-x-4 group-hover:translate-x-0 pointer-events-none hidden sm:block">
                دعم فني مباشر
            </div>
            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(37,211,102,0.4)] hover:scale-110 active:scale-95 transition-all border-4 border-white/10">
